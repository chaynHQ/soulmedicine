...
RSpec.describe 'Courses', type: :request do
  ...
  #     }
  #
  #     # courses_service = double("courses_service")
  #     # allow(courses_service).to receive(:get_course_and_lesson).and_return([course, course.lessons.first])
  #     allow(controller).to receive(:course)
