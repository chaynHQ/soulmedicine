...
ActiveRecord::Schema.define(version: 2019_11_13_164611) do
  ...
  create_table "note_reactions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id"
    ...
    t.index ["user_id", "course_slug"], name: "index_note_reactions_on_user_id_and_course_slug"
